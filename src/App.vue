<template>
  <div class="container">
    ...
    <div v-else class="bg-blue text-white">Herhangi bir ürün yoltur...</div>
...
export default {
  ...
  methods: {
    onSave(e) {
      axios.post("http://localhost:3000/items", { title: e.target.value, created_at: new Date(), completed: false }).then((save_response) => {
